 ...
 */
UCLASS()
class MYPROJECT_API UAuraAbilitySystemLibrary : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
public:
	...
	/* WidgetController End */
	
	/* Ability System Class Defaults Start */
	...
	/* AuraGameplayEffectContext Getter Start */
	...
	/* AuraGameplayEffectContext Getter End */
	
	/* AuraGameplayEffectContext Setter Start */
	...
	/* AuraGameplayEffectContext Setter End */
	...
	/* UnLua Start */
	UFUNCTION(BlueprintCallable, Category = "UnLua|GameplayTags")
	static FGameplayTag RequestGameplayTag(const FName& TagName, bool ErrorIfNotFound = true);

	UFUNCTION(BlueprintCallable, Category = "UnLua|GameplayTags")
	static AActor* FetchActor(FActorInstanceHandle HitObjectHandle);
	/* UnLua End */
